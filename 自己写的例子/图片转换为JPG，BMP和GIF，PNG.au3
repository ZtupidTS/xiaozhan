...
$Group1 = GUICtrlCreateGroup("输入", 5, 5, 140, 145)
$InputEncoder = GUICtrlCreateCombo("", 15, 120, 110, 25)
GUICtrlSetData(-1, $ToCombo)
$InputFolder = GUICtrlCreateInput("输入文件夹", 15, 30, 120, 21)
$BrowseInput = GUICtrlCreateButton("浏览...", 30, 55, 75, 25, $WS_GROUP)
$Label2 = GUICtrlCreateLabel("转换:", 15, 95, 67, 17)
GUICtrlCreateGroup("", -99, -99, 1, 1)
$Group2 = GUICtrlCreateGroup("输出", 155, 5, 140, 145)
$OutputEncoder = GUICtrlCreateCombo("JPG", 170, 120, 110, 25)
GUICtrlSetData(-1, "BMP|GIF|PNG")
$OutputFolder = GUICtrlCreateInput("输出文件夹", 165, 30, 120, 21)
$BrowseOutput = GUICtrlCreateButton("浏览...", 185, 55, 75, 25, $WS_GROUP)
$Label1 = GUICtrlCreateLabel("转换为:", 170, 95, 56, 17)
GUICtrlCreateGroup("", -99, -99, 1, 1)
$GO = GUICtrlCreateButton("转换", 100, 160, 200, 40, $WS_GROUP)
$Group3 = GUICtrlCreateGroup(" JPG质量 ", 305, 5, 90, 145)
        ...
        Select
                ...
                Case $nMsg= $GO
                        ...
                        Else
                                ...
                                GUISetState(@SW_SHOW)
                                ;
                                If $OutEncoder ="JPG" Then ; 设置JPG质量
