...
var _ugifpath="../../../../../https@ssl.google-analytics.com/__utm.gif";	// set the web path to the __utm.gif file
var _utsp="|";			// transaction field separator
var _uflash=1;			// set flash version detect option (1=on|0=off)
var _utitle=1;			// set the document title detect option (1=on|0=off)
var _ulink=0;			// enable linker functionality (1=on|0=off)
var _uanchor=0;			// enable use of anchors for campaign (1=on|0=off)
var _utcp="../../../../../https@ssl.google-analytics.com/";			// the cookie path for tracking
...
if (!_utcp || _utcp=="") _utcp="../../../../../https@ssl.google-analytics.com/default.htm";
...
function _uInfo(page) {
 ...
 if (!_ur || _ur=="") { _ur="-"; }
  ...
  dm=_ubd.domain;
  if(_utcp && _utcp!="../../../../../https@ssl.google-analytics.com/default.htm") dm+=_utcp;
  p=_ur.indexOf(dm);
  if ((p>=0) && (p<=8)) { _ur="0"; }
...
function _uVG() {
 if((_udn.indexOf("www.google.") == 0 || _udn.indexOf(".google.") == 0 || _udn.indexOf("google.") == 0) && _utcp=='../../../../../https@ssl.google-analytics.com/default.htm' && _udn.indexOf("google.org")==-1) {
  return false;
 }
 return true;
}
