...
#AutoIt3Wrapper_outfile=C:\Documents and Settings\Administrator\桌面\111.exe
...
$Version = "QQLoginV1.0_By_xiaozhan"
...
GUICtrlCreateLabel("By: 小站", 189, 274, 78, 17)
...
Func _About()
        ...
        $Label1 = GUICtrlCreateLabel("QQ登陆器 V1.0", 70, 40, 142, 17, $WS_GROUP)
        GUICtrlSetFont(-1, 10, 800, 0, "宋体")
        GUICtrlCreateLabel("xiaozhan(修改版)", 70, 80, 100, 17)
        $Wangzhi = GUICtrlCreateLabel("bbs.yayaw.com", 70, 102, 100, 17)
        GuiCtrlSetCursor($Wangzhi,0)
    GUICtrlSetColor(-1, 0x0000FF)
        GUICtrlCreateLabel("版权为PCBar所有，盗版大概不究。", 20, 144, 200, 17, $WS_GROUP)
        GUICtrlCreateLabel("欢迎加入丫丫网络论坛大家庭", 20, 168, 194, 17)
        ...
        While 1
                Switch GUIGetMsg()
						...
						;Case $Mail
										...
										_RunDos("start Http://bbs.yayaw.com ")
...
;*********************************************************************************************************************
;_Singleton("myScript")
Global $inifile, $main, $mykey
$main = "号码编辑与功能设定"
$inifile = @ScriptDir & "\qq.ini"
$mykey = @ComputerName
Global $edit_qqhm, $edit_mm, $edit_hide, $setpwd
Global $regpath = 'HKLM\Software\DeepQQ'
Opt("WinTitleMatchMode", 4)
$Form1_1 = GUICreate($main, 298, 335, -1, -1, BitOR($WS_SYSMENU, $WS_CAPTION, $WS_POPUP, $WS_POPUPWINDOW, $WS_BORDER, $WS_CLIPSIBLINGS))
$Group1 = GUICtrlCreateGroup("QQ号码编辑", 8, 8, 281, 142)
$List1 = GUICtrlCreateList("", 16, 24, 121, 125,BitOR($WS_BORDER, $WS_VSCROLL, $LBS_NOTIFY))
GUICtrlSetFont(-1, 9, 500)
$Button1 = GUICtrlCreateButton("添加", 143, 24, 65, 25, 0)
$Button2 = GUICtrlCreateButton("删除", 215, 24, 65, 25, 0)
$Button3 = GUICtrlCreateButton("编辑", 144, 56, 65, 25, 0)
$Button4 = GUICtrlCreateButton("刷新", 215, 56, 65, 25, 0)
$Button5 = GUICtrlCreateButton("导入...", 143, 116, 65, 25, 0)
$Button6 = GUICtrlCreateButton("导出...", 216, 116, 65, 25, 0)
GUICtrlCreateGroup("", -99, -99, 1, 1)
$Group2 = GUICtrlCreateGroup("功能设定", 8, 158, 281, 132)
$Label1 = GUICtrlCreateLabel("QQ程序所在路径:", 16, 177, 99, 17)
GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
$Input1 = GUICtrlCreateInput(IniRead($inifile, "setup", "qqpath", "未知"), 16, 201, 265, 21)
$Button7 = GUICtrlCreateButton("自动查找", 120, 173, 65, 22, 0)
$Button8 = GUICtrlCreateButton("手动指定", 200, 173, 65, 22, 0)
$Checkbox1 = GUICtrlCreateCheckbox("进入设定功能需要密码", 16, 230, 140, 25)
GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
$Button9 = GUICtrlCreateButton("设置密码...", 180, 230, 82, 22, 0)
If RegRead($regpath, "needpwd") = "1" Then
	GUICtrlSetState($Checkbox1, $gui_checked)
Else
	GUICtrlSetState(-1, $gui_disable)
EndIf
$Label2 = GUICtrlCreateLabel("启用登录延时:[0为禁用]", 16, 262, 150, 17)
GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
$Input2 = GUICtrlCreateInput("0", 152, 262, 40, 18, BitOR($ES_NUMBER, $es_center))
$updown = GUICtrlCreateUpdown(-1)
GUICtrlSetLimit($updown, 10, 0)
$Label3 = GUICtrlCreateLabel("秒.", 200, 262, 16, 17)
GUICtrlSetFont(-1, 10, 400, 0, "MS Sans Serif")
GUICtrlCreateGroup("", -99, -99, 1, 1)
$Button10 = GUICtrlCreateButton("确定", 50, 300, 65, 28, 0)
$Button11 = GUICtrlCreateButton("退出", 188, 300, 65, 28, 0)
;~ $Button12 = GUICtrlCreateButton("应用", 215, 315, 65, 28, 0)
;~ GUISetState(@SW_SHOW)
#EndRegion ### START Koda GUI section ### Form=d:\autoit\qq自动登陆\form2.kxf
#Region ### START Koda GUI section ### Form=d:\autoit\qq自动登陆\form3.kxf
$Form2_1 = GUICreate("pcbar", 260, 175, -1, -1, BitOR($WS_SYSMENU, $WS_CAPTION, $WS_POPUP, $WS_POPUPWINDOW, $WS_BORDER, $WS_CLIPSIBLINGS), -1, $Form1_1)
$Group2_1 = GUICtrlCreateGroup("请输入QQ帐号信息", 8, 7, 245, 125)

$Label2_1 = GUICtrlCreateLabel("Q Q 号码:", 18, 30, 55, 20)
$Label2_2 = GUICtrlCreateLabel("Q Q 密码:", 18, 55, 55, 20)
$Label2_3 = GUICtrlCreateLabel("重复密码:", 18, 80, 55, 20)
$Input2_1 = GUICtrlCreateInput("", 79, 26, 110, 17, $ES_NUMBER,$WS_EX_STATICEDGE)
GUICtrlSetLimit(-1,11)
$Input2_2 = GUICtrlCreateInput("", 79, 51, 160, 17, $ES_PASSWORD,$WS_EX_STATICEDGE)
$Input2_3 = GUICtrlCreateInput("", 79, 76, 160, 17, $ES_PASSWORD, $WS_EX_STATICEDGE)
$Checkbox2_1 = GUICtrlCreateCheckbox("隐身", 199, 26, 42, 17)
$Checkbox2_2=GUICtrlCreateCheckbox("使用自定义昵称", 18, 104, 105, 17)
$Input2_4=GUICtrlCreateInput("", 125, 104, 114, 17,-1 , $WS_EX_STATICEDGE)
GUICtrlCreateGroup("", -99, -99, 1, 1)
$Button2_1 = GUICtrlCreateButton("保存", 40, 140, 68, 25, 0)
$Button2_2 = GUICtrlCreateButton("退出", 150, 140, 68, 25, 0)
GUISetState(@SW_SHOW, $Form1_1)
;~ GUISetState(@SW_SHOW,$Form2_1)
#EndRegion ### START Koda GUI section ### Form=d:\autoit\qq自动登陆\form3.kxf
...
While 1
	...
	If $nMsg[1] = $Form1_1 Then
		Switch $nMsg[0]
			...
			Case $Button3;编辑
				If _GUICtrlListBox_GetCurSel($List1) <> -1 Then
					$selqqhm = _GUICtrlListBox_GetText($List1, _GUICtrlListBox_GetCurSel($List1))
					
					editqq('编辑QQ号码', $selqqhm, readmm($selqqhm), IniRead($inifile, 'qqlist', $selqqhm, "40"),IniRead($inifile, _
					$selqqhm,"name",""))
				Else
					MsgBox(262144 + 48, "警告", "请选择一个QQ号码!!", 10)
				EndIf
			Case $Button4;刷新
				showQQ()
			Case $Button5;导入
			...
			Case $Button6;导出
				toout()
			Case $Button7;自动查找
				$qqpath_tmp = RegRead("HKEY_LOCAL_MACHINE\SOFTWARE\TENCENT\QQ", "install")
				If FileExists($qqpath_tmp) Then
					GUICtrlSetData($Input1, $qqpath_tmp & "qq.exe")
				EndIf
			Case $Button8;手动指定
				$qqpath_tmp = FileOpenDialog("请指定QQ文件所在路径", "", "可执行文件(*.exe)|所有文件(*.*)", 3, "QQ.exe")
				If FileExists($qqpath_tmp) Then
					GUICtrlSetData($Input1, $qqpath_tmp)
				EndIf
			Case $Checkbox1;启用密码
			...
			Case $Button9;设置密码
				$setpwd_tmp = InputBox("请输入密码:", "请输入进入号码编辑与功能设定的密码:", "", "*M30", "-1", "120", "-1", "-1")
				If @error = 1 Then
					GUICtrlSetState($Checkbox1, $gui_unchecked)
					GUICtrlSetState($Button9, $gui_disable)
				Else
					
					$setpwd = InputBox("请重复密码:", "请输入进入号码编辑与功能设定的密码:", "", "*M30", "-1", "120", "-1", "-1")
					If $setpwd <> $setpwd_tmp Then
						MsgBox(0, "注意", "你两次输入的密码不一样,请重新指定")
						GUICtrlSetState($Checkbox1, $gui_unchecked)
						GUICtrlSetState($Button9, $gui_disable)
					EndIf
				EndIf
		...
		EndSwitch
	ElseIf $nMsg[1] = $Form2_1 Then
		Switch $nMsg[0]
			Case $GUI_EVENT_CLOSE
				GUISetState(@SW_HIDE, $Form2_1)
			Case $Button2_2;退出
				GUICtrlSetData($Input2_4, "")
				GUISetState(@SW_HIDE, $Form2_1)
				Case $Checkbox2_2;启用密码
				If GUICtrlRead($Checkbox2_2) = $gui_checked Then
					GUICtrlSetState($Input2_4, $gui_enable)
				Else
					GUICtrlSetState($Input2_4, $gui_disable)
				EndIf
			Case $Button2_1;保存
				saveQQ()
		EndSwitch
...
Func showQQ()
	...
	Local $qqhm
	$qqhm = IniReadSection($inifile, "qqlist")
	If IsArray($qqhm) Then
		For $i = 1 To $qqhm[0][0]
			_GUICtrlListBox_AddString($List1, $qqhm[$i][0])
		Next
	Else
		Return
	EndIf
...
;添加，编辑，
Func editqq($title = 'QQ', $hm = '', $mm = '', $hide = 41,$name="")
	GUISetState(@SW_SHOW, $Form2_1)
	WinSetTitle($Form2_1, "", $title)
	GUICtrlSetData($Input2_1, $hm)
	GUICtrlSetData($Input2_2, $mm)
	GUICtrlSetData($Input2_3, $mm)
	if $name="" then 
		GUICtrlSetState($Checkbox2_2, $gui_unchecked)
		GUICtrlSetState($Input2_4, $gui_disable)
	Else
		GUICtrlSetState($Checkbox2_2, $gui_checked)
	    GUICtrlSetData($Input2_4, $name)
	EndIf
	
	If $hide = 40 Then
		GUICtrlSetState($Checkbox2_1, $gui_checked)
	Else
		GUICtrlSetState($Checkbox2_1, $gui_unchecked)
	EndIf
...
Func delQQ()
	Local $tmp, $tmp1
	$tmp = _GUICtrlListBox_GetCurSel($List1)
	If $tmp = -1 Then
		MsgBox(262144 + 48, "警告", "请选择一个QQ号码!!", 10)
		Return
	EndIf
	$tmp1 = _GUICtrlListBox_GetText($List1, $tmp)
	IniDelete($inifile, "qqlist", $tmp1)
	IniDelete($inifile, $tmp1)
;~ 	MsgBox(0, 0, $tmp1)
	showQQ()
EndFunc   ;==>delQQ
...
Func readmm($hm)
	Local $tmp
	$tmp = IniRead($inifile, $hm, "qqmm", "")
	$tmp = _StringEncrypt(0, $tmp, $mykey)
	Return $tmp
EndFunc   ;==>readmm

Func saveconfig()
	Local $tmp_path, $tmp_pwd_yn, $tmp_wait
	$tmp_path = GUICtrlRead($Input1)
	If $tmp_path <> "" Then
		IniWrite($inifile, "setup", "qqpath", $tmp_path)
	EndIf
	If GUICtrlRead($Checkbox1) = $gui_checked Then
		RegWrite($regpath, "needpwd", "reg_sz", "1")
		RegWrite($regpath, "password", "reg_sz", mymima(1, $setpwd))
	Else
		RegWrite($regpath, "needpwd", "reg_sz", "0")
		RegWrite($regpath, "password", "reg_sz", '')
	EndIf
	$tmp_wait = GUICtrlRead($Input2)
	IniWrite($inifile, "setup", "waittime", $tmp_wait)
EndFunc   ;==>saveconfig

Func saveQQ()
if GUICtrlRead($Input2_1)="" then
	MsgBox(0, "注意", "请输入QQ号码!",10)
	Return
EndIf
If GUICtrlRead($Input2_2) = GUICtrlRead($Input2_3) Then
					If GUICtrlRead($Checkbox2_1) = $gui_checked Then
						IniWrite($inifile, "qqlist", GUICtrlRead($Input2_1), "40")
					Else
						IniWrite($inifile, "qqlist", GUICtrlRead($Input2_1), "41")
					EndIf
					IniWrite($inifile, GUICtrlRead($Input2_1), "qqmm", _StringEncrypt(1, GUICtrlRead($Input2_2), $mykey))
					if  GUICtrlRead($Checkbox2_2) = $gui_checked Then
						IniWrite($inifile,GUICtrlRead($Input2_1),"name",GUICtrlRead($Input2_4))
					EndIf
					GUICtrlSetData($Input2_4, "")
					GUISetState(@SW_HIDE, $Form2_1)
					showQQ()
				Else
					MsgBox(0, "注意", "两次输入的密码不一样,请重输!")
					Return
			EndIf
EndFunc
...
Func mymima($x, $y)
	...
	If $x = 1 Then
		Return _StringEncrypt(1, $y, @ComputerName) & _StringEncrypt(1, @ComputerName, @ComputerName)
	ElseIf $x = 0 Then
		$y = StringReplace($y, _StringEncrypt(1, @ComputerName, @ComputerName), '')
		Return _StringEncrypt(0, $y, @ComputerName)
	EndIf
...
Func toout()
	...
	$iMsgBoxAnswer = MsgBox(262196, "注意", "使用本功能导出后，QQ密码将以明文形式保存！" & @CRLF & "请妥善保管导出后的文件．谨防盗号！" & @CRLF & "是否继续？")
	Select
		Case $iMsgBoxAnswer = 6 ;Yes
			$tmp = IniReadSection($inifile, "qqlist")
			If IsArray($tmp) Then
				$tmp1 = FileSelectFolder("请选择导出文件的保存路径：","", 3,@ScriptDir)
				If @error Then Return
				For $i = 1 To $tmp[0][0]
					IniWrite($tmp1&"\QQ_Export.ini","QQlist",$tmp[$i][0],$tmp[$i][1])
					IniWrite($tmp1&"\QQ_Export.ini",$tmp[$i][0],"qqmm",_StringEncrypt(0, IniRead($inifile,$tmp[$i][0],"qqmm",""), $mykey))
				Next
			Else
				MsgBox(262144, "出错!!", "读取配置文件" & $inifile & "出错！" & @CRLF & "请退出后重新运行！", 10)
			EndIf
...
Func toin()
	Local $tmp,$tmp1
	$tmp=FileOpenDialog("导入ＱＱ登录配置文件", "", "INI文件(*.ini)|所有文件(*.*)", 3, "QQ_Export.ini")
	if @error then Return
	if FileExists($tmp) Then
			$tmp1 = IniReadSection($tmp, "qqlist")
			If IsArray($tmp1) Then
				For $i = 1 To $tmp1[0][0]
					IniWrite($inifile,"QQlist",$tmp1[$i][0],$tmp1[$i][1])
					IniWrite($inifile,$tmp1[$i][0],"qqmm",_StringEncrypt(1, IniRead($tmp,$tmp1[$i][0],"qqmm",""), $mykey))
				Next
			Else
				MsgBox(262144, "出错!!", "读取配置文件" & $inifile & "出错！" & @CRLF & "请检查后重新运行！", 10)
			EndIf
